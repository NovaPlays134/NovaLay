...
--position-- this is messy asf but ig its the only way if by how i coded the script
...
local PLAYERposX, PLAYERposY = defposX-0.182, defposY-0.020
local PLAYERS_textposX, PLAYERS_textposY = defposX-0.195, defposY+0.010
local CHARACTERposX, CHARACTERposY = defposX-0.050, defposY-0.020
local CHARACTER_textposX, CHARACTER_textposY = defposX-0.050, defposY+0.010
local GENERALposX, GENERALposY = defposX-0.117, defposY+0.210
local GENERAL_textposX, GENERAL_textposY = defposX-0.195, defposY+0.235
...
local posXslider = menu.slider(menu.my_root(), "Speedometer pos X", {}, "Default value is 215", 1, 1000, defposX*1000, 1, function(x)
    ...
    PLAYERposX = x/1000 - 0.182
    PLAYERS_textposX = x/1000 - 0.195
    CHARACTERposX = x/1000 - 0.050
    CHARACTER_textposX = x/1000 - 0.050
...
local posYslider = menu.slider(menu.my_root(), "Speedometer pos Y", {}, "Default value is 125", 1, 1000, defposY*1000, 1, function(y)
    ...
    GENERALposY = y/1000 + 0.210
    GENERAL_textposY = y/1000 + 0.235
...
util.create_tick_handler(function()
    if not util.is_session_transition_active() then
        ...
        if focusedplayer[1] ~= nil and menu.is_open() or (color_show_list or value_show_list or color_show_topbar or color_show_back or color_show_sub or color_show_label or color_show_high or change_bool_show or change_money_show or change_unit_show or posXslider_show or posYslider_show) then

            if (color_show_list or value_show_list or color_show_topbar or color_show_back or color_show_sub or color_show_label or color_show_high or change_bool_show or change_money_show or change_unit_show or posXslider_show or posYslider_show) then
